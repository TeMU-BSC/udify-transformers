...
@Model.register("udify_model_roberta")
class UdifyModelRoberta(Model):
    """
    ...
    def __init__(self,
        ...
        super(UdifyModelRoberta, self).__init__(vocab, regularizer)
