...
@Model.register("udify_model_xlmr")
class UdifyModelXlmr(Model):
    """
    ...
    def __init__(self,
        ...
        super(UdifyModelXlmr, self).__init__(vocab, regularizer)
    ...
    def _apply_token_dropout(self, tokens):
        ...
        if "xlmr" in tokens:
            ...
            tokens["xlmr"] = self.token_dropout(tokens["xlmr"],
                                                oov_token=oov_token,
                                                padding_tokens=ignore_tokens,
                                                p=self.word_dropout,
                                                training=self.training)
