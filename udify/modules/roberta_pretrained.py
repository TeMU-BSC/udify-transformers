...
@TokenIndexer.register("udify-roberta-pretrained")
...
class RobertaEmbedder(TokenEmbedder):
    """
...
@TokenEmbedder.register("udify-roberta-pretrained")
class UdifyPretrainedRobertaEmbedder(RobertaEmbedder):
...
@TokenEmbedder.register("udify-roberta-predictor")
class UdifyPredictionRobertaEmbedder(RobertaEmbedder):
